...
Zdefiniuj zmienną celu jako pojawienie się wpłaty w pierwszych 6ciu miesięcach obsługi. Następnie podziel zbiór danych
...
Utwórz drzewo klasyfikacyjne do modelowania zjawiska czy w sprawie pojawi się wpłata w ciągu pierwszych 6 miesięcy obsługi. Zadanie wykonaj wykorzystując pakiet `rpart`.
