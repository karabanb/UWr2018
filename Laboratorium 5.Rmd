...
## Zadanie 2
 ...
 - Zdefiniuj zmienną celu `IfPayment6M` jako pojawienie się wpłaty w pierwszych 6ciu miesięcach obsługi dla każdego CaseId. 
...
Utwórz drzewo klasyfikacyjne do modelowania zjawiska dokonania wpłaty w  pierwszych 6 miesięcy obsługi. Zadanie wykonaj wykorzystując pakiet `rpart`.
